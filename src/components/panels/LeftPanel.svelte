...
<div class="flex-shrink-0 transition-all duration-500 ease-in-out {leftPanelOpen ? 'w-80 opacity-100' : 'w-0 opacity-0'} overflow-hidden">
  <div class="w-80 h-full flex flex-col bg-gradient-to-br from-white/70 via-white/60 to-white/50 backdrop-blur-xl rounded-2xl shadow-xl shadow-indigo-500/10 border border-gradient">
    <!-- Compact File Uploader -->
    <div class="p-6 border-b border-gradient-light">
